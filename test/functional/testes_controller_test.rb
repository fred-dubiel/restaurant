...
class TestesControllerTest < ActionController::TestCase
  ...
  test "should create testis" do
    assert_difference('Teste.count') do
      post :create, :testis => { :description => @testis.description, :distance => @testis.distance, :price => @testis.price, :quality => @testis.quality, :title => @testis.title }
    end
  ...
  test "should update testis" do
    put :update, :id => @testis, :testis => { :description => @testis.description, :distance => @testis.distance, :price => @testis.price, :quality => @testis.quality, :title => @testis.title }
    assert_redirected_to testis_path(assigns(:testis))
  end
